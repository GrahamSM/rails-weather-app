class WeatherController < ApplicationController
  ...
  def create
    @weather = Weather.new(city: params[:current_observation][:display_location][:full], lat: params[:current_observation][:observation_location][:latitude], lon: params[:current_observation][:observation_location][:longitude], temp_c: params[:current_observation][:temp_c], temp_f: params[:current_observation][:temp_f], relative_humidity: params[:current_observation][:relative_humidity],
